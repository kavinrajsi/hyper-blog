...
const tabContent: Record<TabKey, { title: string; description: string; image: string; btnName: string; btnLink: string; content: number }> = {
  start: {
            ...
            <div className="inline-flex bg-gray-200 rounded-full ">
              {(["start", "existing"] as TabKey[]).map((tab) => (
                <button
                  ...
                  className={`px-6 py-2 text-[25px] font-semibold rounded-full 
                    ${
                      activeTab === tab
          ...
          <div className="flex flex-col items-center justify-between md:flex-row md:gap-8 lg:gap-16">
              ...
              <div className="relative mb-6">
                ...
                <div>
                  <div className="flex items-start mt-3 mb-1">
                    ...
                    <p className="mb-2 text-gray-900">Bring over 10 or 10,000+ blog posts in minutes—with zero data loss.</p>
                    </div>
                  </div>
                  ...
                  <FaArrowRight className="text-[#e57a00] text-lg mr-2 mt-[2px]"/>
                    ...
                    <p className="mb-2 text-gray-900">Preserve your rankings, meta tags, URL structure, and backlinks—without lifting a finger.</p>
                    </div>
                  </div>
                  ...
                  <FaArrowRight className="text-[#e57a00] text-lg mr-2 mt-[2px]"/>
                    ...
                    <p className="mb-2 text-gray-900">Customize the look and feel of your new blog to match your brand perfectly.</p>
                    </div>
                  </div>
                  ...
                  <FaArrowRight className="text-[#e57a00] text-lg mr-2 mt-[2px]"/>
                    ...
                    <p className="mb-2 text-gray-900">Your content stays live while we handle the heavy lifting in the background.</p>
                    </div>
                  </div>
                </div>
                }
                ...
                <div className="mx-auto max-w-xs sm:flex sm:max-w-none sm:justify-start mt-3">
                  <div data-aos="fade-up" data-aos-delay={400}>
                    ...
                    >
                      <span className="relative inline-flex items-center text-white-700 font-bold text-[15px]">
            ...
            <div className="relative flex flex-col">
              <img
                ...
                className="inline-flex mt-auto p-3 max-w-sm"
                alt="Tab Visual"
              />
            </div>
          </div>
